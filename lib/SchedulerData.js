...
var SchedulerData = function () {
    ...
    _createClass(SchedulerData, [{
        ...
        key: 'removeResourceById',
        value: function removeResourceById(resourceId) {
            var index = -1;
            this.resources.forEach(function (item, idx) {
                if (item.id === resourceId) index = idx;
            });
            if (index !== -1) {
                this.resources.splice(index, 1);
                this._createRenderData();
